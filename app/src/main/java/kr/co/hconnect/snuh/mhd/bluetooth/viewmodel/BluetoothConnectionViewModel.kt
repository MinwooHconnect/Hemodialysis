    ...
    private fun setChangedBondState(
        ...
        bondedDevices.value?.let { currentList ->
            ...
            bondedAdapter.submitList(updatedList) {
                this.bondedDevices.value = updatedList
            }
        }
...
//                        val bleState = if (HCBle.isConnect(selDevice)) {BLEState.STATE_CONNECTED} else {BLEState.}
...
//                val strGattState = GATTState.getStateDescription(gattState)
//                Logger.e("onGattServiceState: $strGattState")
//                if (gattState == GATTState.DISCONNECTED) {
//                    setChangedState(selDevice, BLEState.STATE_DISCONNECTED)
//                }
            },
            onSubscriptionState = {
